...
## Maven archetype
 ...
 Maven has many build-in archetype and it can be used to create the Project Folder using archetype:generate
...
Single command to create a maven war project
